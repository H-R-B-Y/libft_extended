...
/*   Updated: 2025/09/16 16:13:30 by hbreeze          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_matrix3d	matrix3d_rotation(t_vec3 rotation)
{
	...
	res[0] = (t_matrix3d){{
		{{1, 0, 0}}, {{0, angles[0], -angles[1]}}, {{0, angles[1], angles[0]}}
	}};
	res[1] = (t_matrix3d){{
		{{angles[2], 0, angles[3]}}, {{0, 1, 0}}, {{-angles[3], 0, angles[2]}}
	}};
	res[2] = (t_matrix3d){{
		{{angles[4], -angles[5], 0}}, {{angles[5], angles[4], 0}}, {{0, 0, 1}}
	}};
