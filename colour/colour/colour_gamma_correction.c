...
t_colour	colour_gamma_correction(t_colour c, float gamma)
{
	...
	steps[0] = (t_u16)(powf((float)c.c.r / 255.0f, inv_gamma) * 255.0f);
	steps[1] = (t_u16)(powf((float)c.c.g / 255.0f, inv_gamma) * 255.0f);
	steps[2] = (t_u16)(powf((float)c.c.b / 255.0f, inv_gamma) * 255.0f);
	steps[3] = (t_u16)(powf((float)c.c.a / 255.0f, inv_gamma) * 255.0f);
	if (steps[0] > 255)
		steps[0] = 255;
	if (steps[1] > 255)
		steps[1] = 255;
