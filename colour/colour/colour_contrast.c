...
t_colour	colour_contrast(t_colour c, float factor)
{
	...
	steps[0] = (t_u16)(f * ((float)c.c.r - 128.0f) + 128.0f);
	steps[1] = (t_u16)(f * ((float)c.c.g - 128.0f) + 128.0f);
	steps[2] = (t_u16)(f * ((float)c.c.b - 128.0f) + 128.0f);
	steps[3] = (t_u16)(f * ((float)c.c.a - 128.0f) + 128.0f);
	if (steps[0] > 255)
		steps[0] = 255;
	if (steps[1] > 255)
		steps[1] = 255;
